...
\begin{esquemaExplorador}
  ...
  \temaEsquema{Correspondencia cuántica}{
    \conceptoEsquema{Amplitud cuántica}
    \conceptoEsquema{Magnitud y probabilidad}{$P = |\alpha|^2$}
    \conceptoEsquema{Fase e interferencia}
  }
...
\begin{itemize}
  ...
  \item $\left(re^{i\theta}\right)^{-1} = r^{-1}e^{-i\theta}$,
  \item para $n\in\Z$, $\left(re^{i\theta}\right)^n = r^ne^{in\theta}$
\end{itemize}
...
\begin{eje}
  ...
  \begin{align*}
     & k=0:\quad z_0 = \sqrt[6]{2}e^{\frac{\pi}{4}i}\,,   \\
     & k=1:\quad z_1 = \sqrt[6]{2}e^{\frac{5\pi}{12}i}\,, \\
     & k=2:\quad z_2 = \sqrt[6]{2}e^{\frac{7\pi}{12}i}\,.
  \end{align*}
\end{eje}

Como elementos geométricos heredados de la geometría en $\R^2$ tenemos:
\begin{itemize}
  \item \textit{Rectas}. En particular, las rectas paralelas a los ejes $\Rp(z) = a$, o $\Ip(z) = b$.
  ...
  \item \textit{Discos} (abiertos o cerrados), también llamados bolas:
