...
Si restringimos el valor del argumento al intervalo $[-\pi, \pi)$, tendremos unicidad en la definición y por este motivo le damos a este valor el nombre de \textbf{argumento principal} y lo denotamos por $\Arg z$.
