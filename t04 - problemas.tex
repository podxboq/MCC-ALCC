...
\begin{questions}
  ...
  \begin{parts}
    \part En $\C^2$: $\langle u, v \rangle = 2u_1\conj{v_1} + u_1\conj{v_2} + u_2\conj{v_1} + 3u_2\conj{v_2}$.
    \part En $\mathcal{M}_2(C)$: $\langle A, B \rangle = \tr(AB^\dagger)$.
  \end{parts}
  ...
  $$\left\{(1, 1, i), (1, i, 0), (i, 1, 1)\right\}\,.$$

  \question Sea $W = \text{gen}\left\{(1, i, 0), (0, 1, i)\right\} \subset \C^3$.
  \begin{parts}
  ...
  \question Sea $V = \mathbb{C}^2$ y $\mathcal{B} = \left\{(1, i), (1, -i)\right\}$.
  \begin{parts}
    \part Verificar que $\mathcal{B}$ es una base de $V$.
    \part Encontrar la base dual $\mathcal{B}^*$ correspondiente.
    \part Expresar $f(x,y) = x + 2y$ como combinación lineal de elementos de $\mathcal{B}^*$.
  \end{parts}
  ...
  \begin{parts}
    ...
    \part Verificar que $\langle Tx, y \rangle = \langle x, T^\dagger y \rangle$ para $x = (1, i)$ y $y = (1+i, 1-i)$.
