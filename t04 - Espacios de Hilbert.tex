...
\begin{defi}
  Sea $A\in \mathcal{M}_n(\C)$. La \textbf{matriz adjunta} de $A$ es la matriz $A^\dagger$ definida por
  \[
...
\begin{eje}[Matriz de Hadamard]
  La matriz de Hadamard es otra de las matrices unitarias fundamentales en computación cuántica
  \[
    H = \frac{1}{\sqrt{2}}\begin{pmatrix} 1 & 1 \\ 1 & -1 \end{pmatrix}\,.
  \]
  Se verifica que $H^2 = I$ y por tanto es unitaria.
\end{eje}
