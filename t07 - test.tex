\begin{questions}
  ...
  \end{choices}
  \begin{solution}
    CNOT invierte el segundo cúbit cuando el primero está en $\ket{1}$: $\text{CNOT}\ket{10} = \ket{11}$.
  \end{solution}
  ...
  \begin{choices}
    ...
    \choice Solo funciona para un cúbit
  \end{choices}
  \begin{solution}
  ...
  \begin{choices}
    \choice Un cúbit
    \choice Dos cúbits
    \CorrectChoice Tres cúbits
    \choice Cuatro cúbits
  \end{choices}
  \begin{solution}
    La puerta Toffoli es un CNOT con dos controles, por tanto requiere tres cúbits: dos de control y uno objetivo.
  \end{solution}
