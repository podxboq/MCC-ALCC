\begin{questions}
  ...
  \begin{parts}
    \part Explique qué significa que un estado cuántico de dos cúbits esté entrelazado. Proporcione un ejemplo de un estado entrelazado y uno separable, y demuestre esta propiedad para ambos casos.
