\begin{questions}
  ...
  \begin{parts}
    \part Defina qué es la esfera de Bloch y explique cómo se utiliza para representar estados de un qubit. Incluya la relación entre las coordenadas en la esfera y los coeficientes del estado cuántico.
