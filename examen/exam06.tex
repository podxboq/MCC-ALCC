\begin{questions}
  ...
  \begin{parts}
    ...
    \part  Si el estado inicial de un cúbit es $|\psi\rangle = \frac{1}{\sqrt{2}}(|0\rangle + |1\rangle)$, calcule el estado después de aplicar el operador $U$ con $\theta = \pi/2$.
  \end{parts}
  ...
  \begin{solution}
    ...
    \[
      ...
      = \frac{1}{\sqrt{2}}\begin{pmatrix} e^{i\pi/4} & 0 \\ 0 & e^{-i\pi/4} \end{pmatrix} \begin{pmatrix} 1 \\ 1 \end{pmatrix} = \frac{1}{\sqrt{2}}\begin{pmatrix} e^{i\pi/4} \\ e^{-i\pi/4} \end{pmatrix}
    \]
  \end{solution}
  ...
  \begin{parts}
    ...
    \part Obtenga la matriz de densidad reducida para el segundo cúbit y explique lo que indica sobre el estado de este cúbit.
    \part Si medimos el primer cúbit y obtenemos $|1\rangle$, ¿cuál será el estado del sistema después de la medición?
  \end{parts}
