\begin{questions}
  ...
  \begin{parts}
    ...
    \begin{solution}
      ...
      Usos principales:
      - Representación de estados: $|\psi\rangle = \alpha|0\rangle + \beta|1\rangle$ representa un cúbit en superposición
    ...
    \part Explique el concepto de matriz de densidad y su utilidad en describir estados cuánticos mixtos.
