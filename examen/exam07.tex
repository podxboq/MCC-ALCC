\begin{questions}
  ...
  \begin{parts}
    ...
    \begin{solution}
      ...
      - Para un sistema de dos cúbits, $E = 1$ indica entrelazamiento máximo
      ...
      c) Concurrencia (para dos cúbits):
      ...
      - Posibilita el procesamiento cuántico paralelo: al manipular un cúbit se afecta instantáneamente a otro entrelazado con él
      ...
      - Codificación superdensa: transmite 2 bits clásicos usando 1 cúbit y entrelazamiento
      ...
      - Los códigos correctores de errores cuánticos funcionan entrelazando cúbits de datos con cúbits de síndrome
  ...
  \begin{parts}
    ...
    \part  Obtenga la matriz de densidad reducida $\rho_1$ del primer cúbit.
  \end{parts}
  ...
  \begin{parts}
    ...
    \part  Expresa $|00\rangle$ en términos de los estados de Bell.
