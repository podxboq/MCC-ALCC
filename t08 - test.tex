\begin{questions}
  ...
  \question La matriz de densidad del estado completamente mixto de un cúbit es:
  ...
  \question La entropía de von Neumann del estado completamente mixto $\rho = \frac{I}{2}$ de un cúbit es:
  ...
  \question La evolución de un estado mixto $\rho$ bajo un canal cuántico $\mathcal{E}$ se describe como:
  \begin{choices}
    \choice $\mathcal{E}(\rho) = U \rho U^\dagger$
    \choice $\mathcal{E}(\rho) = \sum_i K_i \rho K_i$
    \CorrectChoice $\mathcal{E}(\rho) = \sum_i K_i \rho K_i^\dagger$
    \choice $\mathcal{E}(\rho) = \rho$
  \end{choices}
  \begin{solution}
    La evolución de un estado mixto bajo un canal cuántico se describe mediante la suma sobre los operadores de Kraus: $\mathcal{E}(\rho) = \sum_i K_i \rho K_i^\dagger$.
  \end{solution}
\end{questions}