\codigonombre{}{MCC-ALCC-25Q108}
\begin{questions}
	\question[4] Responda a las siguientes cuestiones:
	\begin{parts}


		\part Explique cómo se representa un operador lineal mediante una matriz y cómo se calcula la representación matricial de un operador en una base dada. Proporcione un ejemplo relacionado con operadores cuánticos.
		...
		\begin{solution}
			...
			- El cambio de base transforma la matriz del operador mediante: $[T]_{\mathcal{B}'} = P^{-1}[T]_{\mathcal{B}}P$ donde $P$ es la matriz de cambio de base
			...
			Consideremos el operador de Hadamard $H$ que actúa sobre un qubit. Determinaremos su representación matricial en la base computacional $\mathcal{B} = \{|0\rangle, |1\rangle\}$.
	...
	\begin{parts}
		...
		\part Calcule las matrices de densidad reducidas para el primer qubit en ambos estados.
		\part Supongamos que aplicamos la compuerta CNOT al estado $|\psi_2\rangle$. ¿Cuál será el estado resultante y está entrelazado?
	\end{parts}
