...
\begin{questions}
  ...
  \question Encuentra el operador de densidad y la matriz de densidad para los cuatro estados de Bell, así como el operador de densidad reducida para cada qubit.

  \question Demuestra que la matriz densidad es un operador hermitiano. En caso de que no lo sea, proporciona un contraejemplo o menciona las condiciones en las que se cumple esta propiedad.
